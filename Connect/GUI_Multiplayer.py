...
class GUI_Multiplayer:
    def __init__(self):
        ...
        self.player1_label = Label(frame, font=("Impact", 24, BOLD), height=2, width=24, text="Player 1",
                                   bg='#fff263').place(x=200, y=100)
        self.player2_label = Label(frame, font=("Impact", 24, BOLD), height=2, width=24, text="Player 2",
